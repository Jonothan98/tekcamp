...
import com.teksystems.bootcamp.springboot.movierental.customer.CustomerNotFoundException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleAllsException(Exception ex, WebRequest request){
