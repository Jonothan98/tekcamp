...
public class Cart {
    ...
    public ArrayList<Sandwich> sandwichInCart = new ArrayList<>();
    public ArrayList<Plate> plateInCart = new ArrayList<>();
    public ArrayList<AccessoriesChoice> accessoriesInCart = new ArrayList<>();
